...
@router.get('/todos/{todo_id}' , status_code=status.HTTP_200_OK , response_model=TodoRead)
...
@router.put('/todos/{todo_id}' , response_model=TodoRead  , status_code=status.HTTP_201_CREATED) 
